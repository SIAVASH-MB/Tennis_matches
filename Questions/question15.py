...
import pandas as pd
C_Venue=pd.read_csv("MatchVenueInfo.csv",usecols=["country"])
C_M_Away=pd.read_csv("MatchAwayTeamInfo.csv",usecols=["country"])
C_M_Home=pd.read_csv("MatchHomeTeamInfo.csv",usecols=["country"])
